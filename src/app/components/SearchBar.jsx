  ...
  useEffect(() => {
    const filtered = products.filter(
      (product) =>
        ...
        product.externalId.toLowerCase().includes(searchTerm.toLowerCase())
    );
  ...
  return (
    <div className="container max-w-full mx-auto text-center">
      ...
      <input
        ...
        className="p-2 border border-blue-300 rounded mb-4 w-1/2"
      />
      ...
      {!loading && (
        <div className=" container max-w-full">
          <div className="bg-white p-8 mx-auto">
            ...
            <ul className="max-w-full divide-y divide-blue-300">
              {filteredProducts.map((product, index) => (
                <li
                  key={index}
                  className="p-3 sm:pb-4 hover:bg-gray-200 hover:cursor-pointer"
                >
